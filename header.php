...
<div id="wrapper-navbar" class="fixed-top">
    <nav id="navbar" class="navbar navbar-expand-md d-block p-0 pt-2" aria-labelledby="main-nav-label">
        <div class="container-xl py-2 nav-top align-items-center navbar-grid">
            ...
            <a href="/" class="logo--icon d-sm-none d-flex pe-4" aria-label="Synecore Homepage"><img src="<?=get_stylesheet_directory_uri()?>/img/synecore-logo-2.png"></a>
            <div class="button-container d-md-none text-end">
                <button class="navbar-toggler mt-0" type="button" data-bs-toggle="collapse"
